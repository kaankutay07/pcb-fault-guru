...
export const SpinnerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" {...props}>
        ...
        `}</style>
        <path d="M12 2a10 10 0 1 0 10 10" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeDasharray="20 100" className="spinner-anim opacity-25" />
        <path d="M12 2a10 10 0 0 0-3.536 19.36" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeDasharray="20 100" className="spinner-anim" />
    </svg>
);
...
export const FireIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path fillRule="evenodd" d="M12.963 2.286a.75.75 0 00-1.071 1.052A9.75 9.75 0 0110.303 6H9.75a.75.75 0 000 1.5h.553a9.75 9.75 0 01-2.072 3.532.75.75 0 001.07 1.052 8.25 8.25 0 002.264-3.136.75.75 0 00-.236-1.002 8.25 8.25 0 00-1.43-1.066A8.25 8.25 0 008.25 3.75a.75.75 0 000 1.5h.346a8.25 8.25 0 011.666 3.422.75.75 0 001.212.71A9.75 9.75 0 0115 11.25a.75.75 0 001.5 0 8.25 8.25 0 00-2.228-5.468.75.75 0 00-1.31-.546zM15 15.75a.75.75 0 00.75-.75 3 3 0 013-3 .75.75 0 000-1.5 4.5 4.5 0 00-4.5 4.5.75.75 0 00.75.75z" clipRule="evenodd" />
      <path d="M8.25 12.75a.75.75 0 000 1.5h.75a4.5 4.5 0 014.5 4.5.75.75 0 001.5 0 6 6 0 00-6-6h-.75z" />
    </svg>
);
...
export const WrenchIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.83-5.83M11.42 15.17l-3.04-3.04m3.04 3.04L6 21m-4.5-4.5l5.83-5.83M6 21L3 18m3 3l-3-3m11.42-5.83l-3.04-3.04M11.42 8.33L3 16.75m0 0l3 3m-3-3l3-3m5.83-5.83l3.04 3.04" />
    </svg>
);
...
export const ThermometerIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a2.25 2.25 0 110 4.5 2.25 2.25 0 010-4.5zM12 12.75V18.75m0 0a3.375 3.375 0 01-3.375-3.375h6.75A3.375 3.375 0 0112 18.75z" />
  </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a5.25 5.25 0 01-4.526 0l-3.722-.537A2.25 2.25 0 013 15.894v-4.286c0-.97.616-1.813 1.5-2.097M16.5 9.75a3 3 0 00-3-3h-3a3 3 0 00-3 3M16.5 9.75v1.875a3 3 0 01-3 3h-3a3 3 0 01-3-3V9.75" />
  </svg>
);
